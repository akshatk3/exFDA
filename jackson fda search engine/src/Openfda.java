...
public class Openfda {
	...
	String[] spl_set_id;
	String[] package_ndc;
	boolean[] is_original_packager;
	String[] unii;
	String[] pharm_class_moa;
	String[] pharm_class_cs;
	...
	public String[] getSpl_set_id() {
		return spl_set_id;
	}
	public void setSpl_set_id(String[] spl_set_id) {
	...
	public boolean[] getIs_original_packager() {
